  ...
  >
    <el-form :model="menuInfo" :rules="rules" ref="menuInfo">
      ...
      <el-form-item label="菜单类型：" :label-width="formLabelWidth">
       ...
       <el-form-item label="上级菜单：" :label-width="formLabelWidth" placeholder="请选择菜单地址" prop="pid">
        <el-select :disabled="menuInfo.pid==0" v-model="menuInfo.url" placeholder="请选择">
          <el-option label="菜单地址" :value="0">菜单地址</el-option>
          <el-option
...
export default {
  ...
  data() {
    return {
      ...
      urlList:[
          '/menu','/user','/goods','/role','/sort','/specs','/member','/banner','/seck'
      ]
    };
  },
  computed: {
