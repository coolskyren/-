        ...
        >
            <el-form :model="goodsInfo" :rules="rules" ref="goodsInfo">
                <el-form-item
                    ...
                    prop="first_cateid"
                >
                    <el-select @change="cateChange" v-model="goodsInfo.first_cateid" placeholder="请选择">
                        <el-option
...
//引入商品接口
import { getgoodsAdd, getgoodsEdit, getgoodsInfo, getcateList, getspecsList, getspecsInfo } from '../../util/axios'
//调取辅助性函数
